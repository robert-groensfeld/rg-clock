  ...
  */
  ...
  class StyleProperties {
    ...
    whenHostOrRootRule(scope, rule, cssBuild, callback) {
      ...
      let hostScope = is ? _styleTransformer.default._calcHostScope(is, typeExtension) : 'html';
    ...
    transformStyles(element, properties, scopeSelector) {
      ...
      let hostSelector = _styleTransformer.default._calcHostScope(is, typeExtension);
      ...
      let {
        styleRules: rules,
        cssBuild
      } = _styleInfo.default.get(element);
