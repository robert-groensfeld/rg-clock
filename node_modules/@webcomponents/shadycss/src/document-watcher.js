define(["exports", "./style-settings.js", "./style-transformer.js", "./style-util.js"], function (_exports, _styleSettings, _styleTransformer, _styleUtil) {
  ...
  */
  ...
  function getCurrentScope(element) {
    ...
    let idx = classes.indexOf(_styleTransformer.default.SCOPE_NAME);
  ...
  function ensureCorrectSubtreeScoping(element) {
    ...
    const unscopedNodes = window['ShadyDOM']['nativeMethods']['querySelectorAll'].call(element, `:not(.${_styleTransformer.default.SCOPE_NAME})`);
